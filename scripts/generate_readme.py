...
LANG_CONFIG = {
    ...
    "zh": {
        ...
        "notice": "版权与核验说明",
        "notice_text": "没有视频就不收录：每条 Prompt 都必须有可公开下载的结果视频，并镜像保存到 `media/`；不能只保留外部播放链接。相同成片只发布一次，多段有效提示词归到同一视频下。二级指南转载 MiniMax 官方案例时，来源归属 MiniMax，不把转载页面标成原始来源。如果来源只发布视频，可以根据视频反推 Prompt，但必须明确标记为编辑重构，不能冒充创作者原始 Prompt。内容公开可见不代表作者放弃权利。镜像的第三方内容不适用本仓库的 CC BY 4.0，权利人可通过删除申请表要求下架。",
        "stats": "收录统计",
        "browse": "按生成模式浏览",
        "featured": "精选提示词",
        "all": "全部提示词",
